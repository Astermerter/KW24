...
**НЕОБХОДИМЫЕ ДЕЙСТВИЯ ПЕРЕД РАБОТОЙ С ПРОГРАММОЙ**

В дерриктории на уровне с редми нудно создать файл с именем `Dots.txt` и в него положить точки формата:
...
Если вы хотите произвести квадратичную аппроксимацию, введите `K`



**ИТОГ ПРОГРАММЫ**
В той же дерриктории где и файл README.md появится файл `output_dots.txt` в котором будут точки которые с аппроксимированы тем видом который вы выбрали на прошлом этапе